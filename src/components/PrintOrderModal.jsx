  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[60] p-4 backdrop-blur-sm">
      <AnimatePresence>
        ...
        >
          {/* Header */}
          <div className="bg-[#232f3e] p-4 border-b border-gray-700 flex justify-between items-center">
          ...
          <div className="p-6 space-y-6">
            <div className="text-center space-y-2">
              <div className="w-16 h-16 bg-[#00d084]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Printer className="w-8 h-8 text-[#00d084]" />
              </div>
              <h3 className="text-xl font-bold text-white">Venda Concluída!</h3>
              <p className="text-gray-400 text-sm">Deseja imprimir o comprovante desta venda?</p>
            </div>

            {/* Order Summary Card */}
            <div className="bg-[#2d3e52] rounded-lg p-4 space-y-3 border border-gray-600">
              <div className="flex justify-between items-center border-b border-gray-600 pb-2">
                <span className="text-gray-400 text-xs uppercase font-bold">Pedido</span>
                <span className="text-white font-mono font-bold">#{venda.numero_venda || String(venda.id).slice(0, 8)}</span>
              </div>
              <div className="flex justify-between items-center border-b border-gray-600 pb-2">
                <span className="text-gray-400 text-xs uppercase font-bold">Data/Hora</span>
              ...
              <div className="flex justify-between items-center pt-1">
                ...
                <span className="text-[#00d084] text-xl font-black">
